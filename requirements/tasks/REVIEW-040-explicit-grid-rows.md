# REVIEW-040 Anchor the chat column rows explicitly and allow a null header

## Meta

- Task ID: `REVIEW-040`
- Status: `draft`
- BUILD Task: `BUILD-040`
...
- 2026-08-04: REVIEW task created, paired with BUILD-040 (Status: `draft`).
