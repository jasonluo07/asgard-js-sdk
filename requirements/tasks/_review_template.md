# REVIEW-NNN <Title in American English>

<!--
建立新 REVIEW task 時：
1. 複製本檔為 requirements/tasks/REVIEW-NNN-<slug>.md
2. 對應到已完成的 BUILD-NNN task
3. 逐節填入審查結果，移除說明用的 HTML 註解
狀態流：draft → in-progress → done（不得使用 in_progress）
-->
